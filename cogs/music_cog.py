...
class Audio(commands.Cog, name="audio"):
    ...
    async def download(self, context, url_or_title:str):
        ...
        async with context.typing():
            ...
            url, thumbnail, title, description, duration, full_download_path = await AudioYTDLP.download_one(url_or_title)
    ...
    async def download_playlist(self, context, url_or_title:str):
        ...
        async with context.typing():
            ...
            async for path in AudioYTDLP.download_playlist(url_or_title):
                ...
                print(f'\n s3_url:{s3_url}')
                await message.delete()
                await context.channel.send('Playlist download link: ' + s3_url)
